...
const Kerosal = () => {
    ...
    return (
        <div className={cn('relative h-screen flex  items-center w-full',{'justify-center':index==1})}>
            <Image className='object-cover' src={gallery.at(index)!.image} alt="fb" fill />
            <div className='flex justify-between w-full p-5  cursor-pointer absolute z-50'>
