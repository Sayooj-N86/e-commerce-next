    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 xl:grid-rows-2 gap-3 px-6 md:px-12 pt-5 pb-14'>
                <div className=' col-span-1 row-span-2 relative h-[18rem] md:h-[15rem] lg:h-[25rem] w-100 hover:scale-95 transition-all duration-300'>
                ...
                <div className='relative col-span-1 row-span-2 hover:scale-95 transition-all duration-300 h-[18rem] md:h-[15rem] lg:h-[25rem]'>
                    <Image src='/image/women4.jpg' alt='women' fill className='object-cover rounded-lg'/>
                    <div className='absolute bg-gradient-to-r from-blue-500 text-white hover:to-white hover:text-black font-bold text-[0.7rem] md:text-[0.9rem] p-2 md:p-3 bottom-4 start-4 rounded-xl hover:border'>
                        <button>LADIES</button>
                    </div>
                </div>
                <div className='relative col-span-1 row-span-1 hover:scale-95 transition-all duration-300 h-[18rem] md:h-[15rem] lg:h-auto'>
